...
| [**Spider**](https://github.com/suntaoTom/spider) | 桌面端开发者工具 | Tauri 2 + Rust + React | 开发中 · 16 commits | **跨栈**: 从纯 TS 跨到 Rust + TS 双栈, PRD 锚点从 JSDoc 平滑迁移到 Rust `///` doc, IPC 引入了新的"禁硬编码"红线 |
...
> 完整复盘报告: [Spider 方法论复盘](https://github.com/suntaoTom/spider/blob/main/docs/methodology-report.md) · Cpcash 方法论复盘 (私有仓库, 可联系作者获取)
...
| 仓库 | 是什么 | 为什么值得看 |
|------|--------|-------------|
| [**Spider**](https://github.com/suntaoTom/spider) | Tauri 2 桌面工具, 把任意 `claude-code-workflow` 仓库可视化成看板 | 证明框架在 **Rust + React 双栈**和**开发者工具产品**这种形态里都能跑 |
